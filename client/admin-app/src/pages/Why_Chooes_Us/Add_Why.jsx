...
export default function Add_Why() {
    ...
    let saveQuery = (e) => {
        ...
        axios.post(`${apiBaseUrl}whychoose/insert`,formValue)
        .then((res)=>res.data)
        .then((finalRes)=>{
            if(finalRes.status){
            ...
            <section className='w-full'>
                ...
                <div className='w-full min-h-[620px]'>
                    <div className='max-w-[1220px] mx-auto py-5'>
                        ...
                        <form onSubmit={saveQuery} className=' py-3 px-2 border border-t-0 rounded-b-md border-slate-400' autoComplete='off'>
