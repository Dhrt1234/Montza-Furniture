...
export default function HeaderSubCategory({ module, linkName, ids, setIds, getData, parentCategory, subCategory, sub_subcatName, setParentCategory, setSubCategory, setSub_SubcatName, setLimit }) {
                ...
                <div className="bg-[#F9FAFB] p-4 mb-5">
                    <form className="grid grid-cols-[20%_20%_35%_5%] gap-[1%] items-center">
                        ...
                        <select name='parentCategory'
                            ...
                            className='text-[16px] border-2 py-2 px-2 block shadow-md
                        ...
                        <select name='subCategory' className='text-[16px] border-2 py-2 px-2 block shadow-md
                                                             border-gray-400 w-full rounded-lg focus:border-blue-500'
